...
export default function FabricationForm({ initialData = {}, onSubmit, onCancel, isSubmitting }: MaterialFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!form.Date || !form['Supplier Name'] || !form.Description || !weight || !rate) {
