...
export default function StoneForm({ initialData = {}, onSubmit, onCancel, isSubmitting }: MaterialFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div><label className="block text-sm font-semibold">Quantity *</label><input type="number" step="1" name="Quantity" value={form.Quantity} onChange={handleChange} required className="w-full border rounded px-3 py-2" /></div>
